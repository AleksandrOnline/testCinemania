import"./switcher-4b030933.js";import{g as k,a as I,b as w,c as $}from"./catalog_hero-7d2f12c6.js";function C(t){return t.length>20?t.substring(0,20)+"...":t}function B(t,e,o,n,a){if(!t)return;let c="";return n.length?c=C(n.slice(0,2).join(", ")):c="There are no genres",`<li class="gallery-movies-item" data-id="${o}">
